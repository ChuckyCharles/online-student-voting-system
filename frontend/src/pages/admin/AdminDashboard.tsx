    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
       ...
       <div className="grid lg:grid-cols-2 gap-6">
         ...
         <div className="card">
           <div className="flex items-center justify-between mb-5">
             <h2 className="font-semibold text-slate-900">Academic Structure</h2>
             <div className="flex gap-3">
               <Link to="/admin/schools" className="text-xs text-indigo-600 font-semibold hover:underline">Schools</Link>
               <Link to="/admin/departments" className="text-xs text-indigo-600 font-semibold hover:underline">Departments</Link>
               <Link to="/admin/courses" className="text-xs text-indigo-600 font-semibold hover:underline">Courses</Link>
             </div>
           </div>
           <div className="space-y-3">
             {/* Could add some stats here if needed */}
             <p className="text-sm text-slate-500">Manage schools, departments, and courses</p>
           </div>
         </div>
